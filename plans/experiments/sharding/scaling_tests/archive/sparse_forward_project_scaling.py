"""
plans/experiments/sharding/scaling_tests/sparse_forward_project_scaling.py
────────────────────────────────────────────────────────────────────
...
Run from the BETA worktree root:
    ...
    python plans/experiments/sharding/scaling_tests/sparse_forward_project_scaling.py
"""
import os
import gc
import sys
