"""
plans/experiments/sharding/scaling_tests/sparse_back_project_band_sweep.py
─────────────────────────────────────────────────────────────────────────────
...
the BETA worktree root on the GPU box:
    ...
    python plans/experiments/sharding/scaling_tests/sparse_back_project_band_sweep.py
"""
import os
import sys
import argparse
