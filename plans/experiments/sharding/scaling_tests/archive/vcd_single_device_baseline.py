"""
plans/experiments/sharding/scaling_tests/vcd_single_device_baseline.py
────────────────────────────────────────────────────────────────
...
Run on each checkout (from that checkout's root, or with PYTHONPATH set to it):
    ...
    # prerelease checkout:
    python <beta>/plans/experiments/sharding/scaling_tests/vcd_single_device_baseline.py
    # beta checkout:
    python plans/experiments/sharding/scaling_tests/vcd_single_device_baseline.py
