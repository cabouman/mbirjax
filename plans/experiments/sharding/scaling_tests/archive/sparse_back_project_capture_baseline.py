"""
plans/experiments/sharding/scaling_tests/sparse_back_project_capture_baseline.py
──────────────────────────────────────────────────────────────────────────
...
install (which points at the research worktree):
    ...
    PYTHONPATH="$PWD" python \
      <beta>/plans/experiments/sharding/scaling_tests/sparse_back_project_capture_baseline.py
