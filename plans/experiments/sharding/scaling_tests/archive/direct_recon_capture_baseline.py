"""
plans/experiments/sharding/scaling_tests/direct_recon_capture_baseline.py
───────────────────────────────────────────────────────────────────
...
install (which points at the research worktree):
    ...
    PYTHONPATH="$PWD" python \
      <beta>/plans/experiments/sharding/scaling_tests/direct_recon_capture_baseline.py
