"""
plans/experiments/sharding/scaling_tests/sparse_back_project_memory_attribution.py
─────────────────────────────────────────────────────────────────────────────
...
no JAX; one worker subprocess per measurement).  Run from the beta worktree root:
    ...
    python plans/experiments/sharding/scaling_tests/sparse_back_project_memory_attribution.py
"""
import os
import sys
import argparse
