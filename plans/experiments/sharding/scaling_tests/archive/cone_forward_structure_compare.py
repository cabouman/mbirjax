"""
plans/experiments/sharding/scaling_tests/cone_forward_structure_compare.py
────────────────────────────────────────────────────────────────────
...
Run from the BETA worktree root (no CLI args; edit the config block):
    ...
    python plans/experiments/sharding/scaling_tests/cone_forward_structure_compare.py
"""
import os
import sys
import gc
