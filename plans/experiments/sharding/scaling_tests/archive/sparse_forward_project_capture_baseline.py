"""
plans/experiments/sharding/scaling_tests/sparse_forward_project_capture_baseline.py
─────────────────────────────────────────────────────────────────────────────
...
install:
    ...
    PYTHONPATH="$PWD" python \
      <beta>/plans/experiments/sharding/scaling_tests/sparse_forward_project_capture_baseline.py
