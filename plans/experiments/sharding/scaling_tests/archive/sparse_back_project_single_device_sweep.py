"""
plans/experiments/sharding/scaling_tests/sparse_back_project_single_device_sweep.py
─────────────────────────────────────────────────────────────────────────────
...
streaming starts to fit.  Run from the beta worktree root (on the GPU box):
    ...
    python plans/experiments/sharding/scaling_tests/sparse_back_project_single_device_sweep.py
"""
import os
import sys
import argparse
