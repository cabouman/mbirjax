"""
plans/experiments/sharding/sharding_scaling.py
─────────────────────────────────────────
...
Usage:
  ...
  python plans/experiments/sharding/sharding_scaling.py

  # force a specific set of device counts to test
  python plans/experiments/sharding/sharding_scaling.py --device-counts 1 2 4

  # change problem size (number of detector rows — must be divisible by max n_devices)
  python plans/experiments/sharding/sharding_scaling.py --n-rows 256

  # change number of warmup / timed trials
  python plans/experiments/sharding/sharding_scaling.py --warmup 3 --trials 10
"""
import argparse
import os
import time
