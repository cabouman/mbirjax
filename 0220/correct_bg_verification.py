...
def compute_sino_and_params_corr_bg(dataset_dir,
    ...
    background_offset_orig = estimate_background_offset(sino)

    if background_offset == background_offset_orig:
        print("Background offset values from JAX and NumPy match!")
    else:
        print(f"Background offset values from JAX and NumPy do not match! JAX: {background_offset}, NumPy: {background_offset_orig}")
