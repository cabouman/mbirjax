...
def compute_sino_and_params(dataset_dir, downsample_factor=(1, 1), subsample_view_factor=1, crop_pixels_sides=0, crop_pixels_top=0, crop_pixels_bottom=0, alu_unit='mm', bg_option="global", zinger_correction=True, verbose=1):
    """
    ...
    Args:
        ...
        alu_unit (str, optional): The physical unit used to define 1 ALU (Arbitrary Length Unit).
            Defaults to ``'mm'``. Supported values: ``'um'``, ``'mm'``, ``'cm'``, ``'m'``.
