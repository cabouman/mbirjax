...
> **STATUS: E1, E2, E4, E3a, E3b, E3-cleanup, E3-cleanup-2 (configure_sharding hard-delete), E3c, E3f all DONE (CPU-validated, committed); only E5 (RETIRE-marker sweep + doc close-out) remains before the prerelease PR.**  Written after a read-only
