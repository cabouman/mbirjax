...
def forward_project(num_views, num_det_rows, num_det_channels, output_filepath='output.csv'):
...
if __name__ == "__main__":
    ...
    try:
        ...
        output_filepath = "logs/forward_projection_memory.txt"

    forward_project(num_views, num_det_rows, num_det_channels, output_filepath=output_filepath)