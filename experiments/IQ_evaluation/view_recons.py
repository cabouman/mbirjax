...
#
# Examples:
#   python view_recons.py --all
#   python view_recons.py --all --tag full_res
#   python view_recons.py --case bga_no_hart --tag low_res
...
def main():
    ...
    parser.add_argument('--case', choices=sorted(DATASETS), help='Test case to view')
    parser.add_argument('--all', action='store_true', help='View all datasets in turn')
