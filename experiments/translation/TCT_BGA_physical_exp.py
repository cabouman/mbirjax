...
def main():
    ...
    delta_recon_row = tct_model.get_params('delta_recon_row')
    ...
    tct_model.set_params(recon_shape=(80, recon_shape[1], 2000))
    tct_model.set_params(delta_recon_row= delta_recon_row/2)
