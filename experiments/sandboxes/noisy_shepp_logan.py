...
sinogram = sinogram + sigma_noise * np.random.randn(*sinogram.shape) * weights
sinogram = np.clip(sinogram, 0, None)
# mj.slice_viewer(sinogram)
...
sharpness = -1.5
ct_model.set_params(sharpness=sharpness, use_gpu=use_gpu)
