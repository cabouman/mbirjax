...
def main():
    # Select dataset
    dataset = "BGA_normal" # Options: "BGA_HART" or "BGA_normal"
    ...
    # Path to the dataset
    if dataset == "BGA_HART":
        dataset_dir = '/depot/bouman/data/Zeiss/purdue_BGA/17U1-250TC-Normal_Tomo_HART_360_HART.txrm'
    elif dataset == "BGA_normal":
        dataset_dir = '/depot/bouman/data/Zeiss/purdue_BGA/17U1-250TC-Normal_Tomo_No_HART.txrm'
    else:
