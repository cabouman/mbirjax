...
section 3, GPU headroom, of `plans/current_plans.md` — investigating GPU memory access patterns.
...
Current task:  Begin an investigation into the possible approaches, their pros and cons,
possible experiments to run before and during the evaluation of approaches, an evaluation
of complexity of solution versus possible performance improvement, any other relevant considerations.
No code changes yet - just a discussion.  
